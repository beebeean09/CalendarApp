...
## Guidelines
1. The cache can be built in any way you see fit as long as it persists beyond server restarts.
...
* Show a list of upcoming calendar events with event data:
  * Event Title
  * Event Description
  * List of Attendees (with attendance response)
...
4. Run 'npm run start'
5. Go to browser and navigate to http://localhost:3007/ for Hello World
